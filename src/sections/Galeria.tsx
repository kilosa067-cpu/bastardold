...
export default function Galeria() {
  ...
  return (
    <section id="galeria" ref={sectionRef} className="relative w-full py-24 md:py-32 bg-white overflow-hidden">
      <div className="section-padding relative z-10">
        <div className="galeria-header text-center mb-16">
          ...
          <p className="text-[#333]/50 text-lg max-w-xl mx-auto">
            Cada corte es una obra de arte. Precisión, estilo y tradición en cada detalle.
          </p>
        </div>

        {/* Featured slideshow with Ken Burns effect */}
        <div className="relative max-w-5xl mx-auto mb-12 aspect-video rounded-2xl overflow-hidden bg-[#FAFAFA]">
